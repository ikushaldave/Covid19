...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"utils/fetchUtil.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = stateWise;

async function stateWise(q) {
...
},{"moment":"node_modules/moment/moment.js"}],"covid.js":[function(require,module,exports) {
"use strict";

var _fetchUtil = _interopRequireDefault(require("./utils/fetchUtil.js"));

var _chart = _interopRequireDefault(require("chart.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const baseEndPoint = 'https://covid-india-cases.herokuapp.com/'; // let corsProxy = 'https://crossorigin.me/';
...
async function createGraph(labels, data) {
  ...
  let myChart = new _chart.default(ctx, chartConfig);
}

const covidDataStateWise = (0, _fetchUtil.default)(`${baseEndPoint}states`);
const covidDataStateWiseTimeline = (0, _fetchUtil.default)(`${baseEndPoint}statetimeline`);
...
function displayIndiaTimeline(data) {
  ...
  createOptions(); // console.log(Object.keys(covidData));
...
},{"./utils/fetchUtil.js":"utils/fetchUtil.js","chart.js":"node_modules/chart.js/dist/Chart.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
